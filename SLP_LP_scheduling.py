...
def scheduling(initParams, userDemand=None):
    # preprocess
    ...
    # get init load
    initDSS = getInitDemand(dss, initParams, userDemand)
    ...
    while (violatingVolts.any() or violatingLines.any()) or (k < maxIter):
